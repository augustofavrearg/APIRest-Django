...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\Desktop\APIRest Django basico\django-rest'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\Desktop\APIRest Django basico\django-rest\Scripts\deactivate.nu'
